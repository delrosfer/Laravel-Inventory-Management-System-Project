                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Listas de Asistencia</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-striped text-center">
                                    ...
                                    @foreach($dates as $key => $date)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.attendance.show', date("Y-m-d", strtotime($date->date))) }}" class="btn
													btn-info">
                                                    <i class="fa fa-eye" aria-hidden="true"></i>
                                                </a>
                                                <a href="{{ route('admin.attendance.edit', date("Y-m-d", strtotime($date->date))) }}" class="btn
													btn-info">
